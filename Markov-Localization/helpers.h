...
public:
  ...
  /*
    normpdf(X, mu, sigma) computes the probability function at values x using
    the normal distribution with mean mu ans standard deviation std. x, mue
    and sigma must be scalar! The parameter std must be positive.
